             ...
             <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                   <div className="tpfooter__widget footer-col-1 mb-50">
                      ...
                      <p>If you have any question, please <br/> contact us at: 
                         <a href="mailto:support@example.com">support@rangmart.com</a>
                      </p>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                   <div className="tpfooter__widget footer-col-2 mb-50">
                      ...
                      <p>68 St. Vicent Place, Glasgow, Greater <br/> Chennai, India.</p>
                ...
                <div className="col-xl-4 col-lg-6 col-md-8 col-sm-7">
                   <div className="tpfooter__widget footer-col-4 mb-50">
                      ...
                      <div className="tpfooter__widget-newsletter">
                         <p>Subscribe to the rangmart mailing list to receive updates <br/> on new arrivals & other information.</p>
                         <form>
                            <span>
                              <i>
             ...
             <div className="row">
                <div className="col-lg-6 col-md-7 col-sm-12">
                   <div className="tpfooter__copyright">
                      <span className="tpfooter__copyright-text">Copyright © <a href="#">Rangmart</a> all rights reserved. Powered by <a href="mayatechno.com">Mayatechno</a>.</span>
                   </div>
                </div>
