...
const ShopDetailsBox = ({ product, navStyle, topThumb }: IProps) => {
  ...
  const [activeImg, setActiveImg] = React.useState(product.image_url);
          ...
          <div className="col-lg-6">
            <div className="product__details product__sticky">
              <div className="product__details-price-box">
                <h5 className="product__details-price">₹ {product.variants[0].discounted_price}</h5>
                {productInfoList && (
              ...
              <div className="product__details-stock mb-25">
                <ul>
                  <li>
                    Availability: <i>{product.variants[0].stock} In stock</i>
                  </li>
                  <li>
                    Categories: <span>{product.subcategory_name}</span>
                  </li>
                  <li>
                    {/* Tags: <span>{tags.join(", ")}</span> */}
                    Tags: <span>Vegitables,Fruits,Drinks,Fresh</span>
                  </li>
                </ul>
              </div>
